addLayer("a", {
    ...
    resource: "Sun", // Name of prestige currency
    ...
    hotkeys: [
        {key: "s", description: "S: Reset for Suns", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
...
addLayer("b", {
    ...
    color: "#969696",
    requires: new Decimal(10), // Can be a function that takes requirement increases into account
    resource: "Mercury", // Name of prestige currency
    ...
    row: 0, // Row the layer is in on the tree (0 is the first row)
    hotkeys: [
        {key: "M", description: "M: Reset for Mercurys", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
    layerShown(){return true}
})
