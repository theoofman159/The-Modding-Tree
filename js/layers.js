...
addLayer("VC", {
    name: "Very Cold", // This is optional, only used in a few places, If absent it just uses the layer id.
    ...
    hotkeys: [
        {key: "v", description: "V: Reset for Freezers", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
    layerShown(){return true},
    upgrades: {11: { name: " Freezing Points. ",
    description: "Double your point gain.",
